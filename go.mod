module github.com/veil-proto/veil-windows-gui

go 1.26

require (
	fyne.io/fyne/v2 v2.7.4
	github.com/veil-proto/veil v0.0.0-20260703223934-0a5fa61a6aa8
	github.com/veil-proto/veil-windows v0.0.0-20260703224643-0a61b2d5f2a3
